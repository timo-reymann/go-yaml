...
## Any contributions you make will be under the Other
In short, when you submit code changes, your submissions are understood to be under the same [Other](https://github.com/timo-reymann/timo-reymann/go-yaml/blob/main/LICENSE) that covers the project. Feel free to contact the maintainers if that's a concern.
...
## License
By contributing, you agree that your contributions will be licensed under its Other.
